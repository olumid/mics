...
<head>
  ...
  <link rel="stylesheet" href="{{asset('account/css/style.css')}}">
   <link rel="stylesheet" href="{{asset('vendors/font-awesome/css/font-awesome.min.css')}}">
    <!-- PAGE TITLE HERE -->
    <title>Coinfinancepro | Reset Password</title>
          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            ...
            <div class="auth-form-transparent text-left p-3">
               ...
               <form class="pt-3" method="POST" action="{{ route('password.email') }}">
                ...
                <div class="my-3">
                  <button style="background: orange; color: white;" class="btn btn-block btn-lg font-weight-medium auth-form-btn" type="submit" name="login">Send Password Reset Link</button>
                </div>
